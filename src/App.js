...
function App() {
  ...
  return (
    <Container className="App">
      ...
      <p>1. Every shift name should be unique across whole warehouse.<br/>
      2. The length of a shift name can not be longer than 20 characters.<br/>
      3. Only English letters and numbers are allowed in shift names.</p>
